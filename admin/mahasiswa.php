...
$getmahasiswa = tampildata("SELECT * FROM ms_student LEFT OUTER JOIN ms_program_study ON ms_student.id_program_study = ms_program_study.id_prodi LEFT OUTER JOIN ms_faculty ON ms_program_study.id_faculty = ms_faculty.id_faculty");
					...
					<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							...
							<ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
								...
								<li class="breadcrumb-item text-dark">Mahasiswa</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
						...
						<div class="card card-flush">
							...
							<div class="card-header align-items-center py-5 gap-2 gap-md-5">
								...
								<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
									...
									<!--begin::Add product-->
									<a href="admin/mahasiswa_details" class="btn btn-primary">Add Mahasiswa</a>
									<!--end::Add product-->
								</div>
								<!--end::Card toolbar-->
							</div>
							...
							<div class="card-body pt-0">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 " id="kt_datatable_horizontal_scroll">
									...
									<tbody class="fw-semibold text-gray-600">
										<!--begin::Table row-->
										<?php foreach ($getmahasiswa as $data): ?>
											<tr>
												<!--begin::Checkbox-->
												<td>
												...
												<!--begin::Order ID=-->
												<td><?= $data['npm'] ?></td>
												<td><?= $data['faculty_long'] ?> | <?= $data['program_study_long'] ?> | <?= $data['degree'] ?></td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="javascript:;">
																<div class="symbol-label fs-3 bg-light-danger text-danger"><?= $data['student_image'] ?></div>
															</a>
														</div>
														<!--end::Avatar-->
														<div class="ms-5">
															<!--begin::Title-->
															<a href="javascript:;" class="text-gray-800 text-hover-primary fs-5 fw-bold"><?= $data['student_name'] ?></a>
															<!--end::Title-->
														</div>
													</div>
												</td>
												<td><?= $data['student_gender'] ?></td>
												<td><?= $data['student_addressbirth'] ?>/<?= $data['student_datebirth'] ?></td>
												<td><?= $data['student_phone'] ?></td>
												<td><?= $data['student_mail'] ?></td>
												<!--end::Customer=-->
												<!--end::Date Added=-->
												<!--begin::Date Modified=-->
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="admin/mahasiswa_details?id=<?= $data['student_uid'] ?>" class="menu-link px-3">Edit</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#modal_hapus<?= $data['id_student'] ?>" class="menu-link px-3">Delete</a>
														</div>
														<!--end::Menu item-->
													</div>
													<!--end::Menu-->
											...
											<!-- Modal Delete -->
											<div class="modal fade" id="modal_hapus<?= $data['id_student'] ?>" tabindex="-1" aria-hidden="true">
													...
													<form action="" method="POST">
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																...
																<p class="fw-bold"><?= $data['npm'] ?> | <?= $data['student_name'] ?></p>
															</div>
															<!-- Modal Footer -->
															<div class="modal-footer">
																<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
																<button type="submit" name="submit-delete" class="btn btn-danger">Yes</button>
															</div>
														</div>
													</form>
												</div>
