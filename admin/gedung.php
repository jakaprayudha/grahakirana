...
require '../controller/master/buldingController.php';
$getgedung = tampildata("SELECT * FROM ms_building");
				...
				<div id="kt_header" class="header">
					...
					<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Gedung</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
								<li class="breadcrumb-item text-muted">Academic</li>
								<li class="breadcrumb-item text-muted">Ruang Kuliah</li>
								<li class="breadcrumb-item text-dark">Gedung</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
						...
						<div class="card card-flush">
							...
							<div class="card-header align-items-center py-5 gap-2 gap-md-5">
								...
								<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
									...
									<!--begin::Add product-->
									<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#modal_add_gedung" class="btn btn-primary">Add Gedung</a>
									<!--end::Add product-->
								</div>
								<!--end::Card toolbar-->
							</div>
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 " id="kt_datatable_horizontal_scroll">
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<?php foreach ($getgedung as $data): ?>
												...
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="javascript:;">
																<div class="symbol-label fs-3 bg-light-danger text-danger"><?= $data['building_initial'] ?></div>
															</a>
														</div>
														<!--end::Avatar-->
														<div class="ms-5">
															<!--begin::Title-->
															<a href="javascript:;" class="text-gray-800 text-hover-primary fs-5 fw-bold"><?= $data['building_name'] ?></a>
															<!--end::Title-->
														</div>
													</div>
												</td>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#modal_ubah<?= $data['id_building'] ?>" class="menu-link px-3">Edit</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#modal_hapus<?= $data['id_building'] ?>" class="menu-link px-3">Delete</a>
														</div>
														<!--end::Menu item-->
													</div>
													<!--end::Menu-->
											...
											<div class="modal fade" id="modal_ubah<?= $data['id_building'] ?>" tabindex="-1" aria-hidden="true">
												<!--begin::Modal dialog-->
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<form class="form" id="" method="POST">
															...
															<input type="hidden" name="id" value="<?= $data['id_building'] ?>">
															<!--begin::Modal header-->
															...
															<div class="modal-body py-10 px-lg-17">
																...
																<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-7">
																		...
																		<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Kode Gedung harus bersifat kode unik yang disesuaikan dengan nama gedung "></i>
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" required class="form-control form-control-solid" placeholder="" value="<?= $data['building_code'] ?>" name="kode" />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<div class="fv-row mb-7">
																		...
																		<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="3 Huruf Singkatan Inisial Gedung "></i>
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" require required class="form-control form-control-solid" value="<?= $data['building_initial'] ?>" placeholder="" name="inisial" />
																		<!--end::Input-->
																	</div>
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		<label class="required fs-6 fw-semibold mb-2">Nama Gedung</label>
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" required class="form-control form-control-solid" value="<?= $data['building_name'] ?>" placeholder="" name="gedung" />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<div class="fv-row mb-15">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<textarea name="deskripsi" class="form-control form-control-solid" rows="5" id="deskripsi"><?= $data['building_description'] ?></textarea>
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																</div>
											...
											<!-- Modal Delete -->
											<div class="modal fade" id="modal_hapus<?= $data['id_building'] ?>" tabindex="-1" aria-hidden="true">
													...
													<form action="" method="POST">
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																...
																<p class="fw-bold"><?= $data['building_name'] ?></p>
															</div>
															<!-- Modal Footer -->
...
<div class="modal fade" id="modal_add_gedung" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<!--begin::Modal content-->
		<div class="modal-content">
				...
				<div class="modal-body py-10 px-lg-17">
					...
					<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
						...
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<input type="text" required class="form-control form-control-solid" placeholder="" name="gedung" />
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						<!--begin::Input group-->
