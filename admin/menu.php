...
<div class="aside-menu flex-column-fluid ps-5 pe-3 mb-9" id="kt_aside_menu">
   ...
   <div class="w-100 hover-scroll-overlay-y d-flex pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu, #kt_aside_menu_wrapper" data-kt-scroll-offset="100">
      ...
      <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
            ...
            <div class="menu-sub menu-sub-accordion">
               ...
               <div class="menu-item">
                  ...
                  <a class="menu-link <?php echo ($menu == "profile_campus") ? 'active' : ''; ?>" href="admin/profile_campus">
                     ...
                     <span class="menu-title">Data Dasar Kampus</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <!--begin:Menu item-->
               <div data-kt-menu-trigger="click" class="menu-item menu-accordion  <?php echo ($menu == "fakultas" or $menu == "prodi" or $menu == "academic_year" or $menu == "dosen" or $menu == "tenaga_kependidikan" or $menu == "mata_kuliah" or $menu == "mata_kuliah_details" or $menu == "kelas" or $menu == "kelas_details")  ? 'here show' : ''; ?>">
                  ...
                  <div class="menu-sub menu-sub-accordion">
                     ...
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "fakultas") ? 'active' : ''; ?>" href="admin/fakultas">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
                     ...
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "prodi") ? 'active' : ''; ?>" href="admin/prodi">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
                     ...
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "dosen") ? 'active' : ''; ?>" href="admin/dosen">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
                     ...
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "mata_kuliah" or $menu == "mata_kuliah_details") ? 'active' : ''; ?>" href="admin/mata_kuliah">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
               ...
               <div data-kt-menu-trigger="click" class="menu-item menu-accordion  <?php echo ($menu == "gedung" or $menu == "ruang_kelas") ? 'here show' : ''; ?>">
                  ...
                  <span class="menu-link">
                     ...
                     <span class="menu-title">Ruang Kuliah</span>
                     <span class="menu-arrow"></span>
                  </span>
                  <!--end:Menu link-->
                  <!--begin:Menu sub-->
                  <div class="menu-sub menu-sub-accordion">
                     ...
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "ruang_kelas") ? 'active' : ''; ?>" href="admin/ruang_kelas">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
                           <span class="menu-title">Ruangan Kelas</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                  </div>
               ...
               <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link <?php echo ($menu == "mahasiswa" or $menu == "mahasiswa_details") ? 'active' : ''; ?>" href="admin/mahasiswa">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
         ...
         <!--end:Menu item-->
         <!--begin:Menu item-->
         <div data-kt-menu-trigger="click" class="menu-item  <?php echo ($menu == "rak" or $menu == "kategori_buku" or $menu == "penerbit" or $menu == "penulis" or $menu == "buku") ? 'here show menu-accordion' : ''; ?>" href="admin/index">
            <!--begin:Menu link-->
            <span class="menu-link">
               <span class="menu-icon">
                  <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
            ...
            <div class="menu-sub menu-sub-accordion">
               <div class="menu-item">
                  ...
                  <a class="menu-link <?php echo ($menu == "rak") ? 'active' : ''; ?>" href="admin/rak">
                     ...
                     <span class="menu-title">Rak Perpustakaan </span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <div class="menu-item">
               ...
               <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link <?php echo ($menu == "penerbit") ? 'active' : ''; ?>" href="admin/penerbit">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
               ...
               <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link <?php echo ($menu == "penulis") ? 'active' : ''; ?>" href="admin/penulis">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
               ...
               <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link <?php echo ($menu == "buku") ? 'active' : ''; ?>" href="admin/buku">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
