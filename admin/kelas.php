									...
									<tbody class="fw-semibold text-gray-600">
										...
										<?php foreach ($getprodi as $data): ?>
											<tr>
												...
												<?php
												$kelas = mysqli_query($koneksi, "SELECT * FROM ms_class WHERE id_program_study = '$data[id_prodi]'");
												$totalkelas = mysqli_num_rows($kelas);
												?>
												<td><?= number_format($totalkelas) ?></td>
												<!--end::Date Modified=-->
												<!--begin::Action=-->
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="admin/kelas_details?id=<?= $data['id_prodi'] ?>" class="menu-link px-3">Kelas</a>
														</div>
														<!--end::Menu item-->
													</div>
													<!--end::Menu-->
