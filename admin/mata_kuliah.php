									...
									<tbody class="fw-semibold text-gray-600">
										...
										<?php foreach ($getprodi as $data): ?>
											<tr>
												...
												<?php
												$matakuliah = mysqli_query($koneksi, "SELECT * FROM ms_matakuliah WHERE id_program_study = '$data[id_prodi]'");
												$totalmk = mysqli_num_rows($matakuliah);

												$matakuliahsks = mysqli_query($koneksi, "SELECT SUM(matakuliah_sks) AS total_sks FROM ms_matakuliah WHERE id_program_study = '$data[id_prodi]'");
												$totalsks = mysqli_fetch_assoc($matakuliahsks)['total_sks'];
												?>
												<td><?= number_format($totalmk) ?></td>
												<td><?= number_format($totalsks) ?></td>
												<!--end::Date Modified=-->
												<!--begin::Action=-->
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="admin/mata_kuliah_details?id=<?= $data['id_prodi'] ?>" class="menu-link px-3">Mata Kuliah</a>
														</div>
														<!--end::Menu item-->
													</div>
													<!--end::Menu-->
