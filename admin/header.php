<div id="kt_header" class="header">
	...
	<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
		...
		<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
			<!--begin::Heading-->
			<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Hello, <?= $_SESSION['fullname'] ?>
				<small id="currentDateTime" class="text-muted fs-6 fw-semibold ms-1 pt-1"></small>
			</h1>
			<!--end::Heading-->
		</div>
		<!--end::Page title=-->
...
<script>
	function updateDateTime() {
		...
		const formattedDateTime = `Today, ${date} ${monthName} ${hours}:${minutes}:${seconds}`;

		// Tampilkan di dalam elemen dengan ID "currentDateTime"
