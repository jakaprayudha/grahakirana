				...
				<div id="kt_header" class="header">
					...
					<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Daftar Nilai Sementara</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
								<li class="breadcrumb-item text-muted">Academic</li>
								<li class="breadcrumb-item text-dark">DNS</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
							...
							<div class="card-header align-items-center py-5 gap-2 gap-md-5">
								...
								<div class="card-title">
									...
									<div class="d-flex align-items-center position-relative my-1">
										...
										<!--end::Svg Icon-->
										<input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search KRS" />
									</div>
									<!--end::Search-->
								</div>
								<!--end::Card title-->
								...
								<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
									...
									<!--begin::Add product-->
									<a href="../../demo3/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Sinkron DNS</a>
									<!--end::Add product-->
								</div>
								<!--end::Card toolbar-->
							</div>
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr>
											...
											<td data-kt-ecommerce-order-filter="order_id">
												<a href="../../demo3/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">20221</a>
											</td>
											<!--end::Order ID=-->
											<!--begin::Customer=-->
											<td>
												<div class="d-flex align-items-center">
													...
													<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
														<a href="../../demo3/dist/apps/user-management/users/view.html">
															<div class="symbol-label fs-3 bg-light-danger text-danger">RBT2</div>
														</a>
													</div>
													<!--end::Avatar-->
													<div class="ms-5">
														<!--begin::Title-->
														<a href="javascript:;" class="text-gray-800 text-hover-primary fs-5 fw-bold">ROBOT DEV</a>
														<!--end::Title-->
													</div>
												</div>
											</td>
											...
											<td class="text-start pe-0" data-order="Delivering">
												<!--begin::Badges-->
												<div class="badge badge-light-primary">A</div>
												<!--end::Badges-->
											</td>
											<td class="text-start pe-0" data-order="Delivering">
												<!--begin::Badges-->
											...
											<td>-</td>
											<td>
												<div class="badge badge-light-success">Lulus</div>
											</td>
											<!--end::Status=-->
											<!--end::Date Added=-->
											<!--begin::Date Modified=-->
											...
											<td class="text-end">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<a href="student/kartu_ujian_details" class="menu-link px-3">View</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
												...
												<div class="card card-xxl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #CBF0F4">
													...
													<div class="card-body d-flex flex-column">
														...
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<a href="#" class="text-dark text-hover-primary fw-bold fs-3">Total Nilai</a>
															<!--end::Title-->
														</div>
														<!--end::Wrapper-->
														<!--begin::Stats-->
														<div class="pt-5">
															...
															<!--end::Number-->
															<!--begin::Text-->
															<span class="text-dark fw-bold fs-8 lh-0">- 12% this week</span>
															<!--end::Text-->
														</div>
														<!--end::Stats-->
													</div>
											...
											<div class="col-xl-4">
												...
												<div class="card card-xxl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #CBF0F4">
													...
													<div class="card-body d-flex flex-column">
														...
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<a href="#" class="text-dark text-hover-primary fw-bold fs-3">Total SKS</a>
															<!--end::Title-->
														</div>
														<!--end::Wrapper-->
														<!--begin::Stats-->
														<div class="pt-5">
															<!--begin::Number-->
															<span class="text-dark fw-bold fs-3x me-2 lh-0">157</span>
															<!--end::Number-->
															<!--begin::Text-->
															<span class="text-dark fw-bold fs-8 lh-0">S1 Sistem Informasi</span>
															<!--end::Text-->
														</div>
														<!--end::Stats-->
													</div>
											...
											<div class="col-xl-4">
												...
												<div class="card card-xxl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #CBF0F4">
													...
													<div class="card-body d-flex flex-column">
														...
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<a href="#" class="text-dark text-hover-primary fw-bold fs-3">Total SKS Di Ambil</a>
															<!--end::Title-->
														</div>
														<!--end::Wrapper-->
														<!--begin::Stats-->
														<div class="pt-5">
															<!--begin::Number-->
															<span class="text-dark fw-bold fs-3x me-2 lh-0">18</span>
															<!--end::Number-->
															<!--begin::Text-->
															<span class="text-dark fw-bold fs-8 lh-0">139 Belum Ambil</span>
															<!--end::Text-->
														</div>
														<!--end::Stats-->
													</div>
