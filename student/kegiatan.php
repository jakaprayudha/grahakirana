				...
				<div id="kt_header" class="header">
					...
					<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Kegiatan Mahasiswa</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
								<li class="breadcrumb-item text-muted">Academic</li>
								<li class="breadcrumb-item text-dark">Kegiatan</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
						...
						<div class="card card-flush">
							...
							<div class="card-header align-items-center py-5 gap-2 gap-md-5">
								...
								<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
									...
									<!--begin::Add product-->
									<a href="../../demo3/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Add Kegiatan</a>
									<!--end::Add product-->
								</div>
								<!--end::Card toolbar-->
							</div>
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr>
												...
												<div class="d-flex align-items-center">
													...
													<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
														<a href="../../demo3/dist/apps/user-management/users/view.html">
															<div class="symbol-label fs-3 bg-light-danger text-danger">EV1</div>
														</a>
													</div>
													<!--end::Avatar-->
													<div class="ms-5">
														<!--begin::Title-->
														<a href="javascript:;" class="text-gray-800 text-hover-primary fs-5 fw-bold">SEMINAR NASIONAL</a>
														<!--end::Title-->
													</div>
												</div>
											</td>
											...
											<td class="text-start" data-order="Delivering">
												<!--begin::Badges-->
												Pengaruh Platform Sosial Media Terhadap Daya Tarik Sales
												<!--end::Badges-->
											</td>
											<!--end::Status=-->
											<!--begin::Total=-->
											...
											<td class="text-end" data-order="2022-07-13">
												<div class="badge badge-light-success">Serifikat</div>
											</td>
											<!--end::Date Modified=-->
											<!--begin::Action=-->
											<td class="text-end">
