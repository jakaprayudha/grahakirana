      ...
      <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
         ...
         <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
            ...
            <div class="menu-sub menu-sub-accordion">
               ...
               <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link <?php echo ($menu == "khs") ? 'active' : ''; ?>" href="student/khs">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
               ...
               <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link <?php echo ($menu == "kartu_ujian" or $menu == "kartu_ujian_details") ? 'active' : ''; ?>" href="student/kartu_ujian">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
                     <span class="menu-title">Kartu Ujian</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <!--end:Menu item-->
               ...
               <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link <?php echo ($menu == "dns") ? 'active' : ''; ?>" href="student/dns">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
                     <span class="menu-title">Daftar Nilai Sementara</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <!--end:Menu item-->
               <!--begin:Menu item-->
               <div data-kt-menu-trigger="click" class="menu-item menu-accordion  <?php echo ($menu == "internship" or $menu == "projects" or $menu == "hki" or $menu == "publication") ? 'here show' : ''; ?>">
                  <!--begin:Menu link-->
                  <span class="menu-link">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                  ...
                  <div class="menu-sub menu-sub-accordion">
                     ...
                     <div class="menu-item">
                        ...
                        <a class="menu-link <?php echo ($menu == "internship") ? 'active' : ''; ?>" href="student/internship">
                           ...
                           <span class="menu-title">Internship (Magang)</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <!--end:Menu item-->
               ...
               <!--end:Menu item-->
               <!--begin:Menu item-->
               <div data-kt-menu-trigger="click" class="menu-item menu-accordion  <?php echo ($menu == "prestasi" or $menu == "penelitian" or $menu == "pengabdian" or $menu == "publication_article" or $menu == "sertifikasi") ? 'here show' : ''; ?>">
                  <!--begin:Menu link-->
                  <span class="menu-link">
                     <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                     </span>
                     <span class="menu-title">SKPI</span>
                     <span class="menu-arrow"></span>
                  </span>
                  <!--end:Menu link-->
                  <!--begin:Menu sub-->
                  <div class="menu-sub menu-sub-accordion">
                     ...
                     <div class="menu-item">
                        ...
                        <a class="menu-link <?php echo ($menu == "prestasi") ? 'active' : ''; ?>" href="student/prestasi">
                           ...
                           <span class="menu-title">Prestasi dan Penghargaan</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <!--end:Menu item-->
                     ...
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "pengabdian") ? 'active' : ''; ?>" href="student/pengabdian">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
                           <span class="menu-title">Pengabdian Masyarakat</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "publication_article") ? 'active' : ''; ?>" href="student/publication_article">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
                           <span class="menu-title">Publikasi Artikel Ilmiah</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <!--end:Menu item-->
                     ...
                     <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php echo ($menu == "sertifikasi") ? 'active' : ''; ?>" href="student/sertifikasi">
                           <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                           </span>
                           <span class="menu-title">Sertifkasi Keahlian</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <!--end:Menu item-->
                     ...
                     <div class="menu-item">
                        ...
                        <a class="menu-link" href="../../demo3/dist/pages/user-profile/documents.html">
                           ...
                           <span class="menu-title">Hak Kekayaan Intelektual</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <!--end:Menu item-->
               ...
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/dashboards/marketing.html">
                     ...
                     <span class="menu-title">Kegiatan Mahasiswa</span>
                  </a>
                  <!--end:Menu link-->
               </div>
            ...
            <div class="menu-sub menu-sub-accordion">
               ...
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/dashboards/marketing.html">
                     ...
                     <span class="menu-title">Riwayat Membaca </span>
                  </a>
                  <!--end:Menu link-->
               </div>
            ...
            <div class="menu-sub menu-sub-accordion">
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/dashboards/marketing.html">
                     ...
                     <span class="menu-title">Module Materi </span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <!--end:Menu item-->
               ...
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/apps/calendar.html">
                     ...
                     <span class="menu-title">Kuis & Tugas</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/apps/calendar.html">
                     ...
                     <span class="menu-title">Ujian Tengah Semester</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/apps/calendar.html">
                     ...
                     <span class="menu-title">Ujian Akhir Semester</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/apps/calendar.html">
                     ...
                     <span class="menu-title">Learning Session</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <!--end:Menu item-->
                  ...
                  <div class="menu-sub menu-sub-accordion menu-active-bg">
                     ...
                     <div class="menu-item">
                        ...
                        <a class="menu-link" href="../../demo3/dist/utilities/wizards/vertical.html">
                           ...
                           <span class="menu-title">P2M </span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <!--end:Menu item-->
               ...
               <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                  ...
                  <div class="menu-sub menu-sub-accordion menu-active-bg">
                     ...
                     <div class="menu-item">
                        ...
                        <a class="menu-link" href="../../demo3/dist/utilities/search/horizontal.html">
                           ...
                           <span class="menu-title">Daftar Organisasi</span>
                        </a>
                        <!--end:Menu link-->
                     </div>
                     <!--end:Menu item-->
                  ...
                  <div class="menu-item">
                     ...
                     <a class="menu-link" href="../../demo3/dist/dashboards/marketing.html">
                        ...
                        <span class="menu-title">Absensi Kehadiran </span>
                     </a>
                     <!--end:Menu link-->
                  </div>
                  <div class="menu-item">
                     ...
                     <a class="menu-link" href="../../demo3/dist/dashboards/marketing.html">
                        ...
                        <span class="menu-title">Pembayaran Kuliah </span>
                     </a>
                     <!--end:Menu link-->
                  </div>
                  <!--end:Menu sub-->
            ...
            <div class="menu-sub menu-sub-accordion">
               ...
               <div class="menu-item">
                  ...
                  <a class="menu-link" href="../../demo3/dist/documentation/getting-started/changelog.html">
                     ...
                     <span class="menu-title">AI Bot</span>
                  </a>
                  <!--end:Menu link-->
               </div>
               <!--end:Menu item-->
